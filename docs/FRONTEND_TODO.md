...
- [x] Audit workspace and backend foundation
- [x] Confirm repository separation strategy
- [x] Scaffold and configure Next.js, TypeScript, linting, and Tailwind
- [x] Add semantic design tokens and dark-mode structure
- [x] Add accessible shared component primitives and showcase route
- [x] Add central API client and error normalisation
- [x] Add TanStack Query and query key conventions
- [x] Add MSW browser/server infrastructure and scenarios
- [x] Add login, logout, forgot-password, reset-password, invite-acceptance, and change-password foundation
- [x] Add HTTP-only-cookie BFF session handling
- [x] Add protected routing and safe return URLs
- [x] Add responsive application shell and role-aware navigation
- [x] Add typed route placeholders for all planned modules
- [x] Implement Client CRM list with URL search/filter/sort/pagination
- [x] Implement Client CRM detail with related-data states
- [x] Add unit and network-integration tests
- [x] Add Playwright auth/protected/client/role/reference-flow coverage
- [x] Verify lint, typecheck, tests, build, automated accessibility, keyboard entry, and responsive behavior
